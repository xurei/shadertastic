...
namespace effect_parameter_source_detail {
...
class effect_parameter_source : public effect_parameter_source_detail::base_param {
    private:
    ...
    public:
        explicit effect_parameter_source(gs_eparam_t *shader_param) : effect_parameter_source_detail::base_param(sizeof(float), shader_param) {
        }
        ...
        void render_property_ui(const char *effect_name, obs_properties_t *props) override {
            ...
            auto *ui_prop = obs_properties_add_list(props, full_param_name.c_str(), label.c_str(), OBS_COMBO_TYPE_LIST, OBS_COMBO_FORMAT_STRING);
            std::list<std::string> sources_list;
            obs_enum_sources(effect_parameter_source_detail::add_source_to_list, &sources_list);
            obs_enum_scenes(effect_parameter_source_detail::add_source_to_list, &sources_list);
