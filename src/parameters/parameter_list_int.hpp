...
namespace effect_parameter_list_int_detail {
...
class effect_parameter_list_int : public effect_parameter_list_int_detail::base_param {
    private:
        int default_value{};
        std::vector<effect_parameter_list_int_detail::list_item> values;

    public:
        explicit effect_parameter_list_int(gs_eparam_t *shader_param) : effect_parameter_list_int_detail::base_param(sizeof(int), shader_param) {
        }
        ...
        void render_property_ui(const char *effect_name, obs_properties_t *props) override {
            std::string full_param_name = get_full_param_name(effect_name);
            auto *list_ui = obs_properties_add_list(
