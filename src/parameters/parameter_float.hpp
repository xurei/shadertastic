...
namespace effect_parameter_float_detail {
    using base_param = effect_param_with_unique_prop<effect_parameter>;
}
class effect_parameter_float : public effect_parameter_float_detail::base_param {
    private:
    ...
    public:
        explicit effect_parameter_float(gs_eparam_t *shader_param) : effect_parameter_float_detail::base_param(sizeof(float), shader_param) {
        }
