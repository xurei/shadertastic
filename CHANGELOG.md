...
## [Unreleased]
## [1.2.0] - 2026-07-24
This version fixes crashes with OBS 32.2.0 and later.
...
### Changed
- Parameters: rewritten code to use mixins
- Gaussian Blur: add `sigma` parameter for control over smoothness of the blur
- Removed old `input_facedetection` options in all meta.json; Fixed warnings showing in the logs
